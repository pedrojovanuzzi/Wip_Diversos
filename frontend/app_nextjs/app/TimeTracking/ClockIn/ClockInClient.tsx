...
const SignatureModal = dynamic(
  () => import("@/components/SignatureModal").then((mod) => mod.SignatureModal),
  { ssr: false }
);
...
export default function ClockInClient({ user }: { user: User | null }) {
  ...
  // Check permission (admin can edit date)
