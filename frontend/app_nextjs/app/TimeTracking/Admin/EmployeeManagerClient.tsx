...
export default function EmployeeManagerClient({ user }: { user: User }) {
  ...
  return (
    <>
      ...
      <div className="p-8 flex flex-col gap-4 justify-center items-center bg-gray-100 min-h-screen">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg mb-8 w-full max-w-2xl">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-2xl overflow-x-auto">
