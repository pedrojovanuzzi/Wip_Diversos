export interface Opnion {
  login: string;
  opnion: string;
  time: string;
}

export default function OpnionList({ people }: { people: Opnion[] }) {
  return (
            ...
            <table className="min-w-full divide-y divide-gray-300 h-screen">
              <thead>
                <tr>
                  ...
                  <th className="px-3 py-3.5 text-sm text-center font-semibold text-gray-900">
                    Horário
                  </th>
                </tr>
              </thead>
