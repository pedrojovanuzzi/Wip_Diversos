        ...
        <div className="mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-8 relative">
          <div className="relative flex items-center">
            ...
            <input
              ...
              type="text"
              id="searchParams"
              className="rounded-lg px-10 bg-white py-2 w-full shadow text-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:border-transparent h-12"
