...
export default function PopUpCancelNFSE({
  setShowPopUp,
  showPopUp,
  setPassword,
  password,
        ...
        <div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
          ...
          >
            <div>
              ...
              <span className="flex justify-center mt-5 font-bold text-red-600">Cancelar NFSE</span>
            ...
            <div className="mt-5 flex flex-col sm:flex-row gap-2">
              <input
                ...
                className="ring-2 ring-indigo-400 p-1 rounded w-full h-10 border"
              />
