...
// Workers desabilitados — o processamento é feito exclusivamente pelo novo controller
// em src/controller/whatsapp/queues.ts para evitar concorrência entre dois workers
// no mesmo queue "whatsapp-incoming".
