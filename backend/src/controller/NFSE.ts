                ...
                .ele("GerarNfseEnvio", { xmlns: "http://www.abrasf.org.br/nfse.xsd" })
                    .ele("Rps", { xmlns: "http://www.abrasf.org.br/nfse.xsd" })
                        .ele("InfDeclaracaoPrestacaoServico", { Id: "rps000000000000001999" })
                            ...
                            .ele("Prestador")
                                .ele("CpfCnpj")
                                .ele("Cnpj").txt(rpsData.cnpj).up()
                                .up()
                                .ele("InscricaoMunicipal").txt("15000").up()
                            .up()
                            .ele("Tomador")
                                .ele("IdentificacaoTomador")
                                    .ele("CpfCnpj")
                                        .ele("Cpf").txt("27600930854").up()
                                    .up()
                                .up()
                                .ele("RazaoSocial").txt("Ivan Moraes").up()
                                .ele("Endereco")
                                    .ele("Endereco").txt("Rua do Tomador").up()
                                    .ele("Numero").txt("123").up()
                                    .ele("Complemento").txt("Sala 123").up()
                                    .ele("Bairro").txt("Centro").up()
                                    .ele("CodigoMunicipio").txt("3505203").up()
                                    .ele("Uf").txt("SP").up()
                                    // .ele("CodigoPais").txt("1058").up()
                                    .ele("Cep").txt("17250000").up()
                                .up()
                                .ele("Contato")
                                    .ele("Telefone").txt("14999999999").up()
                                    .ele("Email").txt("wergerge@gmail.com").up()
                                .up()
                            .up()
