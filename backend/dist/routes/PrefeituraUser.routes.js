...
router.post("/SendOtp", PrefeituraLogin_1.default.SendOtp);
router.post("/SendOtpFacilita", PrefeituraLogin_1.default.SendOtpFacilitaMovel);
router.post("/AuthCode", PrefeituraLogin_1.default.AuthCode);
router.post("/AuthCodeFacilita", PrefeituraLogin_1.default.AuthCodeFacilita);
router.post("/Debug", PrefeituraLogin_1.default.debug);
